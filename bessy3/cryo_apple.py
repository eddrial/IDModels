...
#5.11.24 - building a IVUE24 - initially for CryoAPPLE comparison
...
if __name__ == '__main__':
    ...
    ivue24_horz= parameters.model_parameters(Mova = 0,
                                        periods = 5, 
                                        periodlength = 24,
    ...
    ivue24_vert= parameters.model_parameters(Mova = 0,
                                        periods = 5, 
                                        periodlength = 24,
                                        nominal_fmagnet_dimensions = [15.0,0.0,15.0], 
                                        #nominal_cmagnet_dimensions = [10.0,0.0,15.0],
    ...
    param_sets = [ivue24_horz,ivue24_vert]
    
    
    this_id = id.compensatedAPPLEv2(ivue24_horz)
...
#        figi.savefig("M:\\Work\\IVUE24\\Python\\Results\\Geometry_pics\\row_{}.png".format(i+1))

#Create pics for one period in YZ. this works    5.11.24  
#    for r in range(12):
#        for m in range(ivue24_vert.magnets_per_period):
#            figl = plot_long_geometry(this_id, linewidth = 1, mag_index = 5, highlightrows = [r], highlightmagnets = [m+15])
#            figl.savefig("M:\\Work\\IVUE24\\Python\\Results\\Geometry_pics\\L_row_{}_magnet_{}.png".format(r+1,m))
#            figt = plot_geometry(this_id, linewidth = 1, mag_index = m+15, highlightrows = [r], highlightmagnets = [m+15])
#            figt.savefig("M:\\Work\\IVUE24\\Python\\Results\\Geometry_pics\\T_row_{}_magnet_{}.png".format(r+1,m))
