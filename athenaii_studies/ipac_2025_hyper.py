    ...
    for lam_u in [15,17]:
        for cross_sec in [15,20]:
            for M in [1.32, 1.62]:
                ...
                gaprange = np.arange(3.0, 10.1, 2.0)
                shiftrange = np.arange(0,1+lam_u/2, lam_u/4)
                ...
                rootname = 'cryoAPPLE_M_{}_cs_{}_lam_{}_tilt_20_20250512'.format(M, cross_sec, lam_u)
