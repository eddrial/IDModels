...
def axial_field_plot(model):
    ...
    fig.suptitle('Horizontal Polarisation Field Profile')
...
if __name__ == '__main__':
    ...
    for r in range(12):
        for m in range(6):
            ...
            #figl.savefig("M:\\Work\\Athena_APPLEIII\\Python\\Results\\Geometry_pics\\L_row_{}_magnet_{}.png".format(r+1,m))
            figt = plot_geometry(this_id, linewidth = 1, mag_index = m+15, highlightrows = [r], highlightmagnets = [m+15])
            figt.savefig("M:\\Work\\Athena_APPLEIII\\Python\\Results\\Geometry_pics\\T_row_{}_magnet_{}.png".format(r+1,m))
